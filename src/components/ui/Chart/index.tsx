      ...
      <div className={styles.tooltipGrid}>
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={item.dataKey}
              className={`${styles.tooltipItem} ${indicator === "dot" ? styles.tooltipItemDot : ""}`}
            >
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  {itemConfig?.icon ? (
                    ...
                    !hideIndicator && (
                      <div
                        className={`${styles.indicator} ${styles[`indicator${indicator.charAt(0).toUpperCase() + indicator.slice(1)}`]}`}
                        style={
                          {
                  ...
                  <div className={`${styles.tooltipItemContent} ${nestLabel ? styles.tooltipItemContentNest : ""}`}>
                    {nestLabel ? tooltipLabel : null}
...
function ChartLegendContent({
  ...
  return (
    <div
      className={`${styles.legendContent} ${verticalAlign === "top" ? styles.legendTop : styles.legendBottom} ${className || ""}`}
    >
      {payload.map((item) => {
